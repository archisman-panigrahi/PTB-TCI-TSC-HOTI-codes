...
if exportdata==1
    CSV.write(string(folder_path,"weak_invariant/original/",filename), (; local_marker_PTB_list_middle_points),writeheader=false)
end

if exportdata == 1
    savefig(plt_local_PTB, string(folder_path, "weak_invariant/original/plots/central", filename_without_extension, ".png"))
    savefig(plt_PTB_local_marker_sitewise, string(folder_path, "weak_invariant/original/plots/all", filename_without_extension, ".png"))
end
